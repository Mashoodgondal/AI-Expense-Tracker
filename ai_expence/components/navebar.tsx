...
//               ) : (
//                 <TbMenuDeep className="block h-6 w-6" />
//               )}
//             </button>
//           </div>
//         </div>
...
//                 <UserButton />
//                 <span className="ml-3 text-sm font-medium text-gray-700 dark:text-gray-300">Profile</span>
//               </div>
//             ) : (
//               <button
//                 onClick={() => {
...
const Navbar = () => {
  const [isMobileMenuOpen, setIsMobileMenuOpen] = useState(false);
  const { isLoaded, isSignedIn, user } = useUser();  // ✅ use Clerk client hook
